...
def binary_search(keys, query, lower, upper):
    ...
    if pivot -1 == upper or pivot + 1 == lower: 
        ...
        return binary_search(keys, query, lower, pivot - 1)
    else: 
        return binary_search(keys, query, pivot + 1, upper)
...
if __name__ == '__main__':
    ...
    for q in input_queries:
        print(binary_search(input_keys, q, lower=0, upper=len(input_keys)-1), end=' ')
